...
describe('CredentialService', () => {
  describe('#issue', () => {
    ...
    describe('EdDSA', () => {
      ...
      const keyPair = new Ed25519(seed);
      ...
      customTest
        .nock('https://vc-dev.meeco.me', api => {
          api
            ...
            .reply(201, {
              credential: {
                format: UnsignedCredentialModelDtoFormatEnum.DcsdJwt,
                credential:
  ...
  describe('VC Vault Item', () => {
    ...
    describe('createVerifiableCredentialItem', () => {
      customTest
        ...
        .it('should create a verifiable credential item for format dc+sd-jwt', async () => {
          const credential =
          ...
          const expectedItem = {
            slots: [
              ...
              },
              {
                ...
                value: UnsignedCredentialModelDtoFormatEnum.DcsdJwt,
              },
              {
                slot_type_name: 'key_value',
                label: 'Issuer',
